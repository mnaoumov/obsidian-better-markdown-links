...
// eslint-disable-next-line import-x/first, import-x/imports-first -- vi.mock must precede imports.
import { ConvertLinkPathsToRelativeInFileCommandHandler } from './convert-link-paths-to-relative-in-file-command-handler.ts';

let app: AppOriginal;

describe('ConvertLinkPathsToRelativeInFileCommandHandler', () => {
  ...
  let handler: ConvertLinkPathsToRelativeInFileCommandHandler;
  ...
  beforeEach(async () => {
    ...
    handler = new ConvertLinkPathsToRelativeInFileCommandHandler({ linkConverter });
  ...
  it('should create an instance', () => {
    expect(handler).toBeInstanceOf(ConvertLinkPathsToRelativeInFileCommandHandler);
  });
