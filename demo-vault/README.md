...
- **Otherwise**, download `better-markdown-links-demo-vault.zip` from the [plugin releases](https://github.com/mnaoumov/obsidian-better-markdown-links/releases), unzip it, and in Obsidian choose `Manage vaults...` → `Open folder as vault` → select the `better-markdown-links-demo-vault-<version>` folder it unzips into.
