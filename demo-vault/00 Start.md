...
**How to try it:** open the feature notes below and follow each note's steps. Formatting and converting links are plain editor and command actions - just links to inspect and commands to run. The convert commands live in the Command Palette under **Better Markdown Links: ...**; the formatting settings are documented in [04 Settings](<./04 Settings.md>).
